...
public:
  ...
  void printText(uint8_t left, uint8_t top, const String& text, uint16_t color)
  {
  ...
  void printRussianText(uint8_t left, uint8_t top, const String& text, uint16_t color)
  {
